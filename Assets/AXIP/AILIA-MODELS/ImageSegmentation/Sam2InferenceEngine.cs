...
/// Implementation: AiliaSam2Backend (ailia SDK)
/// </summary>
...
public class Sam2InferenceEngine
{
    ...
    private float[,,] ResizeBilinearHWC(float[,,] src, int srcHeight, int srcWidth, int dstHeight, int dstWidth)
    {
...
// ============================================================
// AiliaSam2Backend: ISam2Backend implementation using ailia SDK
// ============================================================
