 ...
 * Uses the same API as SegmentAnything2Model.cs (ailia.AiliaModel).
 *
 * To use this backend:
 *   1. Add ailia-csharp wrapper files (from https://github.com/ailia-ai/ailia-csharp)
 *   2. Ensure the ailia native library is available (libailia.so / ailia.dll)
 *   3. Define AILIA_SDK in DefineConstants (csproj or command line)
 *   4. The AiliaMigration.cs from ailia-csharp provides Unity type stubs
 */
